# fashion_generalization/preprocessing/validate_transe_data_v2.py
...
PROCESSED_V2_DIR = os.path.join(FASHION_ROOT, "data", "processed_v2")

KG_TRAIN = os.path.join(PROCESSED_V2_DIR, "kg_train.tsv")
KG_VALID = os.path.join(PROCESSED_V2_DIR, "taskA_valid.tsv")
KG_TEST  = os.path.join(PROCESSED_V2_DIR, "taskA_test.tsv")
E2ID     = os.path.join(PROCESSED_V2_DIR, "entity2id.tsv")
R2ID     = os.path.join(PROCESSED_V2_DIR, "relation2id.tsv")
...
if leaks_v == 0 and leaks_t == 0:
    ...
    print(f"  ERROR: {leaks_v} validation + {leaks_t} test triples found in train")
