#!/bin/bash
#SBATCH --job-name=KGE_HPO_fashion_full5rel_v2
#SBATCH --output=/path/to/KG_RS/fashion_generalization/models/TransE/KGE_HPO_fashion_full5rel_v2_%j.log
...
echo "================================================================="
echo "  HPO TransE Fashion - KG COMPLETE 5 RELATIONSHIPS (processed_v2, dim=64 fisso)"
...
echo "Verifica file input (data/processed_v2/)..."
...
python run_hpo_trase_price_pop.py
