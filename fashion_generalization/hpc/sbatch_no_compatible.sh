#!/bin/bash
#SBATCH --job-name=KGE_HPO_fashion_no_compatible
#SBATCH --output=/path/to/KG_RS/fashion_generalization/models/TransE/KGE_HPO_fashion_no_compatible_%j.log
...
echo "================================================================="
echo "  HPO TransE Fashion — ABLATION: NO COMPATIBLE_WITH (worst-case)"
...
python run_hpo_transe_fashion_no_compatible.py
