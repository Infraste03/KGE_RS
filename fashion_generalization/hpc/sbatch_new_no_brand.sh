#!/bin/bash
#SBATCH --job-name=KGE_HPO_fashion_no_brand_v2
#SBATCH --output=/path/to/KG_RS/fashion_generalization/models/TransE/KGE_HPO_fashion_no_brand_v2_%j.log
...
echo "================================================================="
echo "  HPO TransE Fashion — ABLATION: NO BRAND v2 (vocabolario fisso, dim=64 fisso)"
...
python run_hpo_transe_fashion_no_brand_v2.py
