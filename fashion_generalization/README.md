...
The main implementation corresponds to the 3-relation Fashion-Random Knowledge Graph.
...
Contains the main Fashion dataset and the processed files used by the Fashion-Random experiments.
...
- `processed_v3/`: Knowledge Graph generated for the Fashion-Heavy setting;
- `recbole/`: RecBole/SASRec dataset for Fashion-Random;
- `recbole_v3/`: RecBole dataset for Fashion-Heavy.

See `data/README.md` for details.

### `data_v2/`

Contains intermediate data used for the enriched five-relation Fashion-Random preprocessing pipeline.

The enriched Fashion-Random configuration extends the three-relation Fashion-Random Knowledge Graph with:
