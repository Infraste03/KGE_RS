...
# ============================================================================
# Usage:
#   sbatch sbatch_hpo_step4_fashion.sh one_to_one
#   sbatch sbatch_hpo_step4_fashion.sh epoch
# ============================================================================

#SBATCH --job-name=Step4_Fashion_HPO
#SBATCH --output=HPO_Fashion_%x_%j.log
...
scontrol update JobId="$SLURM_JOB_ID" JobName="Step4_Fashion_HPO_${SCHEDULING}" 2>/dev/null || true

STUDY_NAME="step4_fashion_${SCHEDULING}"
STUDY_DIR="fashion_generalization/alternate_learning/hpo_results/${STUDY_NAME}"
...
python fashion_generalization/alternate_learning/run_hpo_step4_fashion.py \
