...
# ============================================================================
# Usage:
#   sbatch ext_epoch_sbatch_hpo_step4_fashion.sh
# ============================================================================

#SBATCH --job-name=Step4_Fashion_HPO_epoch_ext_v1
#SBATCH --output=HPO_ext_v1_epoch_%j.log
...
python fashion_generalization/alternate_learning/ext_epoch_run_hpo_step4_fashion.py \
