"""
load_kg_fashion_5rel.py — Load the Knowledge Graph for Fashion alternate learning.
...
Usage:
    ...
    kg = load_kg_fashion(
        train_path='data/processed_v2/kg_train.tsv',
        valid_path='data/processed_v2/taskA_valid.tsv',
        test_path='data/processed_v2/taskA_test.tsv',
    )
"""
...
def _build_mappings(all_entities: set, all_relations: set):
    ...
    Alphabetical ordering guarantees determinism:
    same dataset -> same IDs.
    """
...
def load_kg_fashion(
    ...
    for e in all_entities:
        _entity_type(e)  # raises ValueError if prefix is not recognized
    ...
    entity_type_indices = {
        prefix: [] for prefix in ENTITY_TYPE_PREFIXES
    }
